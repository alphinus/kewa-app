 ...
 *
 * Form to create a new inspection template.
 * Path: /dashboard/vorlagen/abnahmen/neu
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(data.error || 'Fehler beim Erstellen der Vorlage')
      }
