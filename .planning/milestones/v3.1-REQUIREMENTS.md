# Requirements Archive: v3.1 Production Hardening
...
- [x] **I18N-01**: Source files verified as UTF-8 encoded
- [x] **I18N-02**: All German umlauts corrected (ae→ä, ue→ü, oe→ö) throughout codebase
- [x] **I18N-03**: Database collation verified as UTF-8 for proper German sorting
